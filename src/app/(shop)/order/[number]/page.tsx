      ...
      <div className="relative">
        ...
        <div className="mx-auto mt-10 max-w-md rounded-3xl bg-card p-6 text-left ring-1 ring-line/60">
          ...
          <div className="mt-4 space-y-1.5 border-t border-line pt-4 text-sm">
            <div className="flex justify-between text-muted"><span>Доставка</span><span className="text-fg">{delivery}{order.deliveryCost ? ` · ${formatPrice(order.deliveryCost)}` : ""}</span></div>
            ...
            <div className="flex justify-between pt-2 text-base font-bold"><span>Итого</span><span>{formatPrice(order.total)}</span></div>
          </div>
